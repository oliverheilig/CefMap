...
namespace GeocodingClient.Api
{
    ...
    public partial class PlacesApi : IPlacesApi
    {
        ...
        {
            GeocodingClient.Client.ApiResponse<PlacesSearchResult> localVarResponse = SearchPlacesByTextWithHttpInfo(searchText, categoryFilter, countryFilter, language, center, boundingBox);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  Searches for places based on a single-field text input.
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PlacesSearchResult</returns>
        public GeocodingClient.Client.ApiResponse<PlacesSearchResult> SearchPlacesByTextWithHttpInfo(string searchText, List<string> categoryFilter = default(List<string>), List<string> countryFilter = default(List<string>), string language = default(string), List<double> center = default(List<double>), List<double> boundingBox = default(List<double>), int operationIndex = 0)
        {
            // verify the required parameter 'searchText' is set
            if (searchText == null)
            {
                throw new GeocodingClient.Client.ApiException(400, "Missing required parameter 'searchText' when calling PlacesApi->SearchPlacesByText");
            }
            GeocodingClient.Client.RequestOptions localVarRequestOptions = new GeocodingClient.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            if (center != null)
            {
                localVarRequestOptions.QueryParameters.Add(GeocodingClient.Client.ClientUtils.ParameterToMultiMap("csv", "center", center));
            }
            if (boundingBox != null)
            {
                localVarRequestOptions.QueryParameters.Add(GeocodingClient.Client.ClientUtils.ParameterToMultiMap("csv", "boundingBox", boundingBox));
            }
        ...
        {
            GeocodingClient.Client.ApiResponse<PlacesSearchResult> localVarResponse = await SearchPlacesByTextWithHttpInfoAsync(searchText, categoryFilter, countryFilter, language, center, boundingBox, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  Searches for places based on a single-field text input.
...
namespace GeocodingClient.Model
{
    ...
    public partial class Warning : IEquatable<Warning>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A constant string that can be used to identify this warning class programmatically. A warningCode can have **details** to provide information in additional properties which are described with the code they apply to. They are of type string unless otherwise specified.    Note that additional warningCodes as well as the **details** of existing warningCodes may be added at any time. Furthermore, the **description** may change at any time.    * &#x60;GEOCODING_COUNTRY_FILTER_MODIFIED&#x60; - A given code in **countryFilter** referring to a subdivision of a country was modified to its corresponding country code.     * &#x60;requestedSubdivisionCode&#x60; - The subdivision code that was originally requested.     * &#x60;fallbackCountryCode&#x60; - The country code that was used as a fallback in the search.   * &#x60;GEOCODING_TIMEOUT&#x60; - The search ran into a timeout while trying to find results.   * &#x60;GEOCODING_INPUT_TOO_LONG&#x60; - The input was rejected because it is too long.     * &#x60;maximumSize&#x60; - The maximum allowed size of a singleField request.   * &#x60;TOO_MANY_INPUT_WORDS&#x60; - At least one of the input fields exceeded the maximum number of input words.     * &#x60;inputField&#x60; - The input field that had too many input words.   * &#x60;actualNumberOfWords&#x60; - The number of words found in &#x60;inputField&#x60;.   * &#x60;maximumAllowedNumberOfWords&#x60; - The maximum number of words allowed in &#x60;inputField&#x60;. * &#x60;GEOCODING_TOO_MANY_RESULTS&#x60; - Too many results found. Not all of them are provided in the response.  </value>
